    ...
    public Future<DatabaseConnection> getConnectionAsync() {
        return executorService.submit(() -> {
            if (availableConnections.isEmpty()) {
                ...
                // Implement a mechanism to handle waiting, e.g., using Semaphore or blocking
                // queue
            }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (Future<?> future : futures) {
                future.get(); // Blocking call , we are waiting for the completion of the asynchronous task
                // triggered using submit on the executorService
            }
